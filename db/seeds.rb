...
reservations = Reservation.create([
  ...
  {email: 'super@nova@gmail.com', restaurant_name: 'The Restaurant at the Adelaide', date: Date.today + rand(30), time: 19, number_of_people: 4, restaurant_id: restaurant1.id, user_id: sean.id},
