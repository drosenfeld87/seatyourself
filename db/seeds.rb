User.destroy_all
dmitry = User.create(email: "dmitry@gmail.com", password: "test", password_confirmation: "test", loyalty_points: 0)

alex = User.create(email: "alex@gmail.com", password: "test", password_confirmation: "test", loyalty_points: 0)


debbie = User.create(email: "debbie@gmail.com", password: "test", password_confirmation: "test", loyalty_points: 0)

bill = User.create(email: "bill@gmail.com", password: "test", password_confirmation: "test", loyalty_points: 0)

sean = User.create(email: "sean@gmail.com", password: "test", password_confirmation: "test", loyalty_points: 0)

Restaurant.destroy_all
restaurant1 = Restaurant.create(restaurant_name: 'Reds Wine Tavern', hours_open: 16, hours_closed: 23, capacity: 50, min_size: 2, max_size: 10, url: 'https://resizer.otstatic.com/v2/profiles/legacy/3584.jpg', address: "Toronto", neighbourhood: "Little Italy", price_range: "$$", summary: "Great place to eat", restaurant_url: "google.com", user_id: dmitry.id)
...
restaurant3 = Restaurant.create(restaurant_name: 'Katana on Bay', hours_open: 18, hours_closed: 23, capacity: 30, min_size: 2, max_size: 6, url: 'https://resizer.otstatic.com/v2/profiles/legacy/76546.jpg', address: "Toronto", neighbourhood: "Little Italy", price_range: "$$", summary: "Great place to eat", restaurant_url: "google.com", user_id: dmitry.id)

restaurant4 = Restaurant.create(restaurant_name: 'Canoe Restaurant and Bar', hours_open: 12, hours_closed: 24, capacity: 200, min_size: 5, max_size: 10, url: 'https://resizer.otstatic.com/v2/profiles/legacy/3870.jpg', address: "Toronto", neighbourhood: "Little Italy", price_range: "$$", summary: "Great place to eat", restaurant_url: "google.com", user_id: dmitry.id)

restaurant5 = Restaurant.create(restaurant_name: 'Terroni ADELAIDE', hours_open: 14, hours_closed: 20, capacity: 20, min_size: 2, max_size: 10, url: 'https://resizer.otstatic.com/v2/profiles/legacy/73816.jpg', address: "Toronto", neighbourhood: "Little Italy", price_range: "$$", summary: "Great place to eat", restaurant_url: "google.com", user_id: dmitry.id)
