...
restaurant2 = Restaurant.create(restaurant_name: 'The Restaurant at the Adelaide', hours_open: 19, hours_closed: 24, capacity: 100, min_size: 3, max_size: 8, url: 'https://resizer.otstatic.com/v2/profiles/legacy/984100.jpg', address: "Toronto", neighbourhood: "Little Italy", price_range: "$$", summary: "Great place to eat", restaurant_url: "adelaidehoteltoronto.com", user_id: dmitry.id)

restaurant3 = Restaurant.create(restaurant_name: 'Katana on Bay', hours_open: 18, hours_closed: 23, capacity: 30, min_size: 2, max_size: 6, url: 'https://resizer.otstatic.com/v2/profiles/legacy/76546.jpg', address: "Toronto", neighbourhood: "Little Italy", price_range: "$$", summary: "Great place to eat", restaurant_url: "katanaonbay.com", user_id: dmitry.id)

restaurant4 = Restaurant.create(restaurant_name: 'Canoe Restaurant and Bar', hours_open: 12, hours_closed: 24, capacity: 200, min_size: 5, max_size: 10, url: 'https://resizer.otstatic.com/v2/profiles/legacy/3870.jpg', address: "Toronto", neighbourhood: "Little Italy", price_range: "$$", summary: "Great place to eat", restaurant_url: "canoerestaurant.com", user_id: dmitry.id)
